...
import { Bell, ScanLine, BookOpen } from 'lucide-react-native';
  ...
  const banners = [
    {
      ...
      desc: 'Kalau kamu memaksa buka pintu dengan\ncurang, siap-siap patah di tengah jalan.',
    },
    {
      title: 'Belajar lebih tenang',
      desc: 'Fokus pada kemampuanmu sendiri dan\nkerjakan ujian dengan percaya diri.',
    },
    {
      title: 'Masa depan dimulai hari ini',
      desc: 'Setiap soal yang kamu kerjakan adalah\nlangkah menuju impianmu.',
    },
  ];

  return (
    <View style={styles.container}>
      <StatusBar barStyle="light-content" backgroundColor="#2B22B6" />
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <View style={styles.profileSection}>
            ...
            <View>
              <Text style={styles.namaSiswa}>Halo, {nama} ✌️</Text>
      ...
      <View style={styles.dateCard}>
        <View style={styles.dateLeft}>
          ...
          <View>
            ...
            <Text style={styles.monthText}>November 2027</Text>
          </View>
        </View>
        ...
        <View style={styles.dateRight}>
          ...
          <Text style={styles.scheduleText}>Belum ada ujian</Text>
        </View>
        ...
        <View style={styles.bottomStats}>
          <View style={styles.statItem}>
            ...
            <Text style={styles.statText}>0 Ujian Selesai</Text>
          </View>

          <View style={styles.statItem}>
            <Text style={styles.fireEmoji}>🔥</Text>

            <Text style={styles.statText}>0 Ujian Belum Selesai</Text>
          </View>
        </View>
      </View>
      ...
      >
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.infoLabel}>Kamu duduk di:</Text>

          <View style={styles.infoBadge}>
            <Text style={styles.infoBadgeText}>Data Kosong</Text>
          </View>
        ...
        <View style={styles.startContainer}>
          ...
          <View style={styles.stepCard}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.stepHeading}>Masukkan kode</Text>

              <Text style={styles.stepDesc}>
                Pada beranda terdapat bagian masukkan kode . Isi bagian tersebut
                dengan kode yang dibagikan oleh guru Anda.
              </Text>

              <TouchableOpacity activeOpacity={0.8}>
                <Text style={styles.stepLink}>Masukkan kode →</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.stepCard}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.stepHeading}>Lihat Kelas</Text>

              <Text style={styles.stepDesc}>
                Setelah mengisi kode, Anda berhasil masuk ke kelas yang telah
                dibuat oleh guru Anda.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.stepCard}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.stepHeading}>Kerjakan Ujian</Text>
